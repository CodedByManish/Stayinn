...
function PayPalButton({ amount, onSuccess, onError, disabled }) {
    ...
    loadPayPalSdk().then((paypal) => {
      ...
      paypal.Buttons({
        ...
        createOrder: (data, actions) => actions.order.create({
          purchase_units: [{ amount: { value: String(amount), currency_code: PAYPAL_CURRENCY } }]
        }),
  ...
  return /* @__PURE__ */ jsxDEV("div", { children: [
    /* @__PURE__ */ jsxDEV("div", { ref }, void 0, false, {
      fileName: "<stdin>",
      lineNumber: 82,
      columnNumber: 7
    }, this),
    !ready && !error && /* @__PURE__ */ jsxDEV("p", { className: "muted", style: { fontSize: 13, textAlign: "center", padding: 8 }, children: "Loading PayPal\u2026" }, void 0, false, {
      fileName: "<stdin>",
      lineNumber: 83,
      columnNumber: 28
    }, this),
